...
try:
    ...
    if key == r[b]:
        ...
        u=input("nhập tin nhắn vào đây(lưu ý ko viết in hoa):")
        c=input("nhập thời gian ví dụ(05-30-2022 06:35:00:AM):")
        n=input("nhập ID facebook bạn muốn nhắn ví dụ(100073313124329):")
        ...
        os.system("cls")
        error="Key sai vui lòng nhập lại hoặc liên hệ với nhà cấp key"
